...
module acquisition_controller (
    input  logic        clk,
    input  logic        rst,
    input  logic        intan_read_mode,      // indicates Intan is ready to read.
    ...
    output logic        initializing,         // wire into init_start.
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            // initialize if not initialized until initialized.
            if (!intan_read_mode) begin
                initializing <= 1'b1;
            end else begin
