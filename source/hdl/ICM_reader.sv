...
module ICM_reader #(
    ...
    logic spi_tick;
    logic tick_en;
    localparam integer TICK_COUNTER_WIDTH = (SCLK_HALF_PERIOD_CYCLES > 1) ? $clog2(
    ...
    initial begin
        ...
        if (SCLK_HALF_PERIOD_CYCLES < 1) $error("ICM_reader requires SCLK_HALF_PERIOD_CYCLES >= 1");
    end
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            if (tick_en) begin
                ...
                end else tickCounter <= tickCounter + 1'b1;
            end else begin
                tickCounter <= '0;
                spi_tick <= 1'b0;
            end
        ...
        if (rst) begin
            ...
            case (state)
                ...
                WAIT_DATA: begin
                    ...
                    if (spi_clk_falling) state <= READ_DATA;
                end
