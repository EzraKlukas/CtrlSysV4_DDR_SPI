# Run the Intan reader -> packet writer -> FIFO -> AXI stream layout regression.
#
# Batch usage:
...
set project_dir [file normalize [file join $repo_root build integrate_intan_packet_path_layout_tb_project]]

file delete -force $project_dir
create_project -force integrate_intan_packet_path_layout_tb $project_dir -part xc7z020clg400-1
...
set hdl_files [list \
    ...
    [file join $repo_root source tests hdl integrate_intan_packet_path_layout_tb.sv]]

add_files -norecurse -fileset sim_1 $hdl_files
set_property file_type SystemVerilog [get_files -of_objects [get_filesets sim_1] *.sv]
set_property top integrate_intan_packet_path_layout_tb [get_filesets sim_1]
